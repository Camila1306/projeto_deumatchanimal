...
@endif
{{Form::open(['route'=>'pets.store', 'method'=>'POST', 'enctype'=>'multipart/form-data'])}}
{{Form::label('nome', 'Nome')}}
{{Form::text('nome','',['class'=>'form-control', 'required', 'placeholder'=>'Exemplo:  Luna'])}}
{{Form::label('especie', 'Espécie')}}
{{Form::select('especie',array('Gato'=>'Gato', 'Cachorro'=>'Cachorro'), 'Gato',['class'=>'form-control', 'required'])}}
{{Form::label('porte', 'Porte')}}
{{Form::select('porte',array('Pequeno'=>'Pequeno', 'Médio'=>'Médio','Grande'=>'Grande', 'Gigante'=>'Gigante' ), 'Pequeno',['class'=>'form-control', 'required' ])}}
...
{{Form::select('idade',array('Filhote'=>'Filhote', 'Adulto'=>'Adulto', 'Idoso'=>'Idoso'), 'Filhote',['class'=>'form-control', 'required' ])}}

{{Form::label('tamanho_pelo', 'Sexo')}}
{{Form::select('sexo',array('Feminino'=>' Feminino', 'Masculino'=>'Masculino'), 'Feminino',['class'=>'form-control', 'required'])}}
{{Form::label('tamanho_pelo', 'Tamanho do pelo')}}
{{Form::select('tamanho_pelo',array('Sem pelos'=> 'Sem pelos', 'Curto e liso'=>'Curto e liso', 'Curto e duro'=>'Curto e duro', 'Longo e liso'=>'Longo e liso', 'Longo  e ondulado/encaracolado'=>'Longo  e ondulado/encaracolado', 'Duplo'=> 'Duplo'), 'Sem pelos',['class'=>'form-control', 'required', 'placeholder'=>'Selecione o tamanho_pelo', 'list'=>'listtamanho_pelo' ])}}
